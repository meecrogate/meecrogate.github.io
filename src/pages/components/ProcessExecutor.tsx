        ...
        <section className="py-20 px-6 border-t border-brand-light/10">
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-brand-orange/10 to-brand-orange/20 rounded-xl p-6 border border-brand-orange/20">
              ...
              <div className="bg-gradient-to-br from-brand-blue/10 to-brand-blue/20 rounded-xl p-6 border border-brand-blue/20">
